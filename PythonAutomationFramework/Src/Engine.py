...
from PythonAutomationFramework.Utils.Paths import CHROME_DRIVER_PATH, IE_DRIVER_PATH
from PythonAutomationFramework.Utils.ParseConfig import IMPLICITY_WAIT_TIME,  BROWSER_NAME, BROWSER_WINDOW_SIZE
